About auto-changelog-feedstock
==============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/auto-changelog-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/auto-changelog-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add auto-changelog
# for installing globally
pixi global install auto-changelog
```
...
It is possible to list all of the versions of `auto-changelog` available on your platform:
...
```
pixi search auto-changelog --channel conda-forge
```
